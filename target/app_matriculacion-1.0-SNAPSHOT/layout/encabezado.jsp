...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="././recursos/vendors/ti-icons/css/themify-icons.css">
        <link rel="stylesheet" type="text/css" href="././recursos/js/select.dataTables.min.css">
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo mr-5" href="Dashboard"><b>Matriculacion</b></a>
        <a class="navbar-brand brand-logo-mini" href="Dashboard"><img src="././recursos/images/logo-mini.svg" alt="logo"/></a>
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="././recursos/images/faces/face28.jpg" alt="profile"/>
              <b>${administrador.nombres}</b>
            </a>
